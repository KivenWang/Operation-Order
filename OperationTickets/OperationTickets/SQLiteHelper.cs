...
namespace OperationTickets
{
    ...
    {
        private string connectionString = "Data Source=" + System.Windows.Forms.Application.StartupPath + @"\Database\OperationTickets.db";
        /// <summary> 
        /// 构造函数 
        /// </summary> 
        ...
        /// <summary> 
        /// 对SQLite数据库执行不带参数的增删改操作，返回受影响的行数。 
        /// </summary> 
        ...
        /// <summary> 
        /// 向数据库插入datatable的值，用于添加完成后插入OperationSteps. 
        /// </summary> 
        /// <param name="sql">插入的sql语句</param> 
        /// <param name="parameters">要插入的DataTable,必须以它们在SQL语句中的顺序为准</param> 
        /// <returns></returns> 
        public int InsertDataTable(string sql, DataTable dataTable)
        {
            int affectedRows = 0;
            using (SQLiteConnection connection = new SQLiteConnection(connectionString))
            {
