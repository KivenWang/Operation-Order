    ...
    public class SQLiteHelper1
    {
        ...
        {//"Data Source=Test.db3;Pooling=true;FailIfMissing=false";  
            get
            {
                ...
                //}
                //return text;
                _ConnectionString = "Data Source="+System.Windows.Forms.Application.StartupPath+@"\Database\OperationTickets.db";
        ...
        public static SQLiteConnection Conn
        {
            get
            {
                ...
                return SQLiteHelper1._Conn;
            }
            set { SQLiteHelper1._Conn = value; }
        }
